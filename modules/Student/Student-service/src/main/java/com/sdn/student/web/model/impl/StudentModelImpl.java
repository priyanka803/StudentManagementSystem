...
import com.sdn.student.web.model.StudentModel;
...
public class StudentModelImpl
	...
	public static final Object[][] TABLE_COLUMNS = {
		...
		{"course", Types.VARCHAR}, {"email", Types.VARCHAR}
	};
	...
	public static final String TABLE_SQL_CREATE =
		"create table STUDENT_Student (uuid_ VARCHAR(75) null,studentId LONG not null primary key,firstName VARCHAR(75) null,lastName VARCHAR(75) null,course VARCHAR(75) null,email VARCHAR(75) null)";
	...
	static {
		...
		attributeGetterFunctions.put("course", Student::getCourse);
		attributeSetterBiConsumers.put(
			"course", (BiConsumer<Student, String>)Student::setCourse);
	...
	public Student cloneWithOriginalValues() {
		...
		studentImpl.setCourse(this.<String>getColumnOriginalValue("course"));
	...
	private void _setColumnOriginalValues() {
		...
		_columnOriginalValues.put("course", _course);
